            ...
            if (col) {
                ...
                for (var i: number = 0; i < length; i++) {
                    ...
                    if (obj instanceof GButton) {
                        (<GButton><any> obj).title = <string><any> (cxml.$title);
                        (<GButton><any> obj).icon = <string><any> (cxml.$icon);
                    }
                    else if (obj instanceof GLabel) {
                        (<GLabel><any> obj).title = <string><any> (cxml.$title);
                        (<GLabel><any> obj).icon = <string><any> (cxml.$icon);
                    }
                }
            }
        }
