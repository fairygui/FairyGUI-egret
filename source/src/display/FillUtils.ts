namespace fgui {
    export function fillImage(w: number, h: number, method: number, origin: number, clockwise: boolean, amount: number): Array<number> {
        if (amount <= 0)
            return null;
    ...
    function fillHorizontal(w: number, h: number, origin: number, amount: number): Array<number> {
    ...
    function fillVertical(w: number, h: number, origin: number, amount: number): Array<number> {
    ...
    function fillRadial90(w: number, h: number, origin: number, clockwise: boolean, amount: number): Array<number> {
    ...
    function movePoints(points: Array<number>, offsetX: number, offsetY: number): void {
    ...
    function fillRadial180(w: number, h: number, origin: number, clockwise: boolean, amount: number): Array<number> {
        var points: Array<number>;
        switch (origin) {
            case FillOrigin.Top:
                if (amount <= 0.5) {
    ...
    function fillRadial360(w: number, h: number, origin: number, clockwise: boolean, amount: number): Array<number> {
        var points: Array<number>;
        switch (origin) {
            case FillOrigin.Top:
                if (amount <= 0.5) {
