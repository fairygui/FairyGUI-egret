namespace fgui {
    export class GTree extends GList {
        ...
        private createCell(node: GTreeNode): void {
            var child: GObject = this.getFromPool(node._resURL ? node._resURL : this.defaultItem);
            ...
            if (cc) {
                cc.addEventListener(StateChangeEvent.CHANGED, this.__expandedStateChanged, this);
        ...
        private __cellMouseDown(evt: egret.Event): void {
            var node: GTreeNode = evt.currentTarget._treeNode;
            this._expandedStatusInEvt = node.expanded;
        }

        private __expandedStateChanged(evt: egret.Event): void {
            var cc: Controller = evt.currentTarget;
